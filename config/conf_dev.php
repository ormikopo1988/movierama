...
$wooofConfigOptions = array(
	...
	'siteName'                  =>   'MOVIERAMA v0.1',      // Short Site Name (also used for prefixing log/debug files)
    'siteURLStart'              =>   '',        		
	...
	'fileLog'                   =>   array( false ),               // 
	'logFilePath'               =>   array( 'C:/xampp/htdocs/tmp/logs/' ), // absolute path for file logging (filename is preset)
	'databaseSQLMode'	        =>	 array( '' ),				  // E.g. ANSI,TRADITIONAL  dev.mysql.com/doc/refman/5.0/en/sql-mode.html

	// Main URLs and Paths
	// (do not forget the / at the end!)
	'siteBaseURL'               =>   '/movierama/', 						// the site's base URL (also important for Cookie-based sessions)
	'siteBasePath'              =>   'C:/xampp/htdocs/movierama/', 		// the site's absolute path

	'absoluteFilesRepositoryPath'											// absolute path used for storing file uploads
								=>   'C:/xampp/htdocs/movierama/uploads/',
	...
	'debugLogPath'				=>	'C:/xampp/htdocs/tmp/logs/',	// Absolute path for storing debug files.
	...
	'antiFloodProtection'       =>   30,             // if > 0 the number entered here is the number of requests per second that triger IP Address banning and silent ignoring of subsequent requests
	...
	'initApplicationRoutine'	=>   'initAppMOVIERAMA',			// callable f(WOOOF) that makes custom inits/checks and returns boolean. Called at the end of WOOOF's construction.
