...
var Evaluation = React.createClass({
	...
	handleOpen: function() {
	    ...
	    var url = MOVIERAMA.linkPrefix('api/evaluation/open');
	    //data to send to server!
	    this.setState({
	      loading: true
	    });
	    
	    MOVIERAMA.ajaxCall(url, 'POST', data, this, this.cbHandleOpen);
	},
	...
	handleClose: function() {
	    ...
	    var url = MOVIERAMA.linkPrefix('api/evaluation/close');
	    //data to send to server!
	    this.setState({
	      loading: true
	    });
	    
	    MOVIERAMA.ajaxCall(url, 'POST', data, this, this.cbHandleClose);
	},
	...
	render: function() {
		...
		return (
			<RB.Well>
				<span>
					<a href={MOVIERAMA.linkPrefix('evaluations/view/'+data.whatType+'/'+data.whatId)}><i className="fa fa-eye"></i> View Evaluations</a>
					<br/><br/>
				</span>
